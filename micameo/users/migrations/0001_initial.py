# Generated by Django 2.2.12 on 2020-07-21 00:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(error_messages={'unique': 'A category with that name already exist'}, max_length=30, unique=True, verbose_name='Category')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categorys', to='users.Category')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday', models.DateField(null=True, verbose_name='Day of Birthday')),
                ('description', models.TextField(blank=True, max_length=600, verbose_name='Your Description')),
                ('response_days', models.IntegerField(default=7)),
                ('slug', models.SlugField(blank=True, unique=True)),
                ('price', models.FloatField(default=10.0, verbose_name='Price of cameo')),
                ('categories', models.ManyToManyField(blank=True, related_name='talent_category', to='users.SubCategory')),
